...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thúy Hoan - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0829149228 </p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thúy Hoan - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0829149228 </div>", unsafe_allow_html=True)
